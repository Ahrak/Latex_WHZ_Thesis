...
Zur Arbeit mit dem Sumatra PDF-Viewer unter Windows sind entsprechende Ausgabeprofile für TexNicCenter vorbereitet, die aus der Datei \verb!_tc_output_profiles_sumatra.tco! 
importiert werden können (siehe dazu die Information in Anhang \ref{sec:EinstellungAusgabeprofile}).



\section{DVI-PS-Workflow}
...
einzureichen.%
\footnote{An der FH Hagenberg ist bei Arbeiten zumindest eines der
...
Arbeit eindeutig zuzuordnen ist, am Besten durch ein
gedrucktes Label%
