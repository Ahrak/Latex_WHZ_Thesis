...
Obwohl man meist mit den bisher beschriebenen Varianten das
Auslangen findet, kommt es immer wieder vor, dass spezielle
Quellen zu berücksichtigen sind. Beispiele dafür sind Filme,
Videos oder Musikstücke. Für diese gibt es in BibTeX leider
keine eigenen Vorkehrungen, sie können aber mit dem \texttt{@misc}-Eintrag
...
Die Verwendung von \verb!babelbib! löst auch die früheren Probleme mit der Angabe der Auflagennummer von Büchern. Nunmehr ist lediglich die Nummer selbst anzugeben, also etwa
\begin{quote}
\verb!edition={3}!
\end{quote}
